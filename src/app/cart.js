...
export const createCartUi = ({ id, image, price, title }) => {
  ...
  cart.innerHTML = `
    <div class="group mb-5">
        ...
        alt=""
        />
        <div class="border p-4 pt-12 shadow border-neutral-400 text-neutral-700 relative">

      <button class="cart-remove-btn absolute right-4 top-4 opacity-0 translate-x-10 group-hover:translate-x-0 duration-200  group-hover:opacity-100"> 
        ...
        <div class="flex justify-between ">
            ...
            <p class="text-neutral-500">$ <span class="amount">${price}</span></p>
            <div
...
export const cartQuantityIncrementHandler = (event) => {
  ...
  const currentCartCost = currentCart.querySelector(".amount");
...
export const calculateRecordCostTotal = () => {
  const cartCost = [...app.querySelectorAll(".amount")].reduce(
